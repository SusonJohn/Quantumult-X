...
#CrazyJoy专门收集金币
CrazyJoy专门收集金币
仅仅是收集一下CrazyJoy专门收集金币活动每秒产生的金币
每半小时运行一次
============Quantumultx===============
[task_local]
#CrazyJoy专门收集金币
0 0/30 * * * ? https://github.com/q10539670/Quantumult-X/blob/main/Script/jd_crazyJoyCollect.js, tag=京东收金币, enabled=true

================Loon==============
[Script]
cron "0 0/30 * * * ?" script-path=https://github.com/q10539670/Quantumult-X/blob/main/Script/jd_crazyJoyCollect.js,tag=京东收金币

===============Surge=================
京东收金币 = type=cron,cronexp="0 0/30 * * * ?",wake-system=1,timeout=3600,script-path=https://github.com/q10539670/Quantumult-X/blob/main/Script/jd_crazyJoyCollect.js
...
!(async () => {
    ...
    console.log(`\n小功能::仅仅是收集一下crazyJoy领金币每秒产生的金币,建议半个小时跑一次脚本\n`)
